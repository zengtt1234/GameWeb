<template>
  <el-container style="height: 100%;">
    <el-aside width="auto" style="background-color: rgb(238, 241, 246)">
      <!-- <el-menu router  unique-opened :default-active='$route.path' background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
        <el-submenu index="1">
    ...
    <el-container>
      <el-header style="box-shadow: 0 1px 4px rgba(0, 21, 41, 0.1);">
